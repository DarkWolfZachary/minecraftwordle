...
function getWordList() {
    return ['block', 'spawn', 'witch', 'biome', 'armor', 'build', 'drops', 'grief', 'tools', 'steve', 'magma', 'forge', 'anvil', 'miner', 'shift', 'smelt', 'smite', 'torch', 'steak', 'trade', 'shear', 'sheep', 'mason', 'sneak', 'breed', 'hacks', 'chunk', 'coord', 'coral', 'craft', 'caves', 'ender', 'apple', 'golem', 'melee', 'farms', 'ocean', 'pearl', 'picks', 'seeds', 'stack', 'admin', 'ghast', 'noobs', 'skins', 'troll', 'dupes', 'arrow', 'books', 'bones', 'chest', 'clock', 'death', 'flint', 'stone', 'trees', 'blaze', 'slime', 'honey', 'ingot', 'bread', 'cakes', 'cocoa', 'beans', 'melon', 'sugar', 'world', 'birch', 'bowls', 'brick', 'boots', 'sword', 'fence', 'gates', 'ferns', 'fuels', 'glass', 'coals', 'berry', 'clays', 'bales', 'wheat', 'stair', 'tunic', 'lilac', 'poppy', 'carts', 'slice', 'plank', 'tulip', 'paper', 'peony', 'rails', 'signs', 'igloo', 'stick', 'squid', 'allay', 'vines', 'water', 'doors', 'llama', 'flesh', 'stews', 'beets', '', ];
}
